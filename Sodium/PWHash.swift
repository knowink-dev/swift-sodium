...
extension PWHash {
    ...
    public class SCrypt {
        ...
        public func str(passwd: Bytes, opsLimit: Int, memLimit: Int) -> String? {
            ...
            guard .SUCCESS == crypto_pwhash_scryptsalsa208sha256_str(
                &output,
                passwd,
                CUnsignedLongLong(passwd.count),
                CUnsignedLongLong(opsLimit),
                size_t(memLimit)).exitCode else { return nil }
        ...
        public func strVerify(hash: String, passwd: Bytes) -> Bool {
            ...
            return .SUCCESS == crypto_pwhash_scryptsalsa208sha256_str_verify(
                hashBytes,
                passwd,
                CUnsignedLongLong(passwd.count)).exitCode
        }
        ...
        /**
         ...
         - Returns: The derived key data.
         */
        public func hash(outputLength: Int, passwd: Bytes, salt: Bytes, opsLimit: Int, memLimit: Int) -> Bytes? {
            ...
            guard .SUCCESS == crypto_pwhash_scryptsalsa208sha256(
                &output,
